...
## Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=py,matlab,mysql,html,css,opencv,django,flask)](https://skillicons.dev)
[![My Skills](https://skillicons.dev/icons?i=,tensorflow,cpp,git,github,pycharm,vscode,arduino,raspberrypi,autocad,discord,sklearn,tailwind)](https://skillicons.dev)
