...
## Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=py,matlab,mysql,html,css,opencv,django,flask,bootstrap,sklearn,tailwind,docker,linux,replit,php)](https://skillicons.dev)
