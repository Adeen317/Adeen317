...
[![My Skills](https://skillicons.dev/icons?i=py,matlab,mysql,html,css,opencv,django,flask,tensorflow,cpp,git,github,pycharm,vscode,arduino,raspberrypi,autocad,discord)](https://skillicons.dev)
