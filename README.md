...
## Languages and Tools:
[![My Skills](https://skillicons.dev/icons?i=py,matlab,mysql,html,css,opencv,django,flask,bootstrap,sklearn,tailwind,docker,langchain)](https://skillicons.dev)
[![My Skills](https://skillicons.dev/icons?i=tensorflow,cpp,git,github,pycharm,vscode,arduino,raspberrypi,autocad,discord,aws,fastapi,mongodb)](https://skillicons.dev)
